...
# find absolute path to node - /Users/student/.nvm/versions/node/v6.9.5/bin/node
...
# crontab -e
# use VIM editor to enter the following line. 'i' to enter insert mode. 'Escape' key to exit insert mode. :w to save file. :q to quit. 
